    ...
    def __init__(
        ...
        super(DINOTransformerEncoder, self).__init__(
            transformer_layers=BaseTransformerLayer(
                ...
                ffn=Mix_MLP(input_dim=embed_dim, hidden_dim=feedforward_dim,
                            output_dim=embed_dim, num_layers=2),
                norm=nn.LayerNorm(embed_dim),
                operation_order=("self_attn", "norm", "yyffn", "norm"),
            ),
    ...
    def __init__(
        ...
        super(DINOTransformerDecoder, self).__init__(
            transformer_layers=BaseTransformerLayer(
                ...
                # ffn=Mix_MLP(input_dim=embed_dim, hidden_dim=feedforward_dim,
                #             output_dim=embed_dim, num_layers=2),
                ffn=FeedForward(embed_dim, feedforward_dim, 0.1, nn.ReLU(), True, False, False, False),
                norm=nn.LayerNorm(embed_dim),
                operation_order=(
                    "self_attn",
                    "norm",
